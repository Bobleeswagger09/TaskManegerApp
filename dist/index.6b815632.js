...
const taskManager = new (0, _taskManager.TaskManager)();
...
taskForm.addEventListener("submit", (e)=>{
    ...
    if (editingTaskId) {
        ...
        const newTask = new (0, _task.Task)(title, description, priority);
...
function renderTasks() {
    ...
    taskManager.getTasks().forEach((task)=>{
        ...
        taskText.textContent = `${task.getTaskInfo().title} - ${task.getTaskInfo().priority}`;
        taskText.classList.add("task-text");
        if (task.getTaskInfo().completed) taskText.classList.add("completed");
        ...
        editBtn.onclick = ()=>{
            ...
            document.getElementById("title").value = taskInfo.title;
            document.getElementById("description").value = taskInfo.description;
            document.getElementById("priority").value = taskInfo.priority;
...
},{"./Task":"jtozD","./TaskManager":"3hJzi"}],"jtozD":[function(require,module,exports,__globalThis) {
...
},{}],"3hJzi":[function(require,module,exports,__globalThis) {
// TaskManager.ts
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "TaskManager", ()=>TaskManager);
var _task = require("./Task");
class TaskManager {
    addTask(task) {
    ...
    loadFromLocalStorage() {
        ...
        this.tasks = storedTasks.map((task)=>new (0, _task.Task)(task.title, task.description, task.priority));
    }
    constructor(){
        this.tasks = [];
    }
...
},{"./Task":"jtozD","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["3sN7K","kuM8f"], "kuM8f", "parcelRequire94c2")
